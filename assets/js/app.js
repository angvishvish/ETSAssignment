...
var connectionArray = [];/* to store connection between which elements*/
...
function drawLine(){
  for(var i =0;i<connectionArray.length;i++){
    ...
    var left1 = parseInt(firstElement.style.left);
    var left2 = parseInt(secondElement.style.left);
